...
const imgSrcURL =
  "https://images.unsplash.com/photo-1504884790557-80daa3a9e621?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=640&q=80";
...
class App extends React.Component {
  ...
  cropImg = () => {
    ...
    this.resizeCanvasRef
      .getContext("2d")
      .drawImage(this.canvasRefImg, 0, 0, sanitizedWidth, sanitizedHeight);
    // set src of canvasRefImg with imageData
          ...
          onResizeStop={(e, direction, ref, delta, position) => {
            this.setState(
              ...
              () => {
                ...
                // );
                /******************************************/
                // test - reload img and recalc b64 values ~ no noticeable improvement
                /******************************************/
                // const sanitizedWidth = sanitize(this.state.width);
                // const sanitizedHeight = sanitize(this.state.height);
                // this.resizeCanvasRef.width = sanitizedWidth;
                // this.resizeCanvasRef.height = sanitizedHeight;
                // const newImg_ = new Image();
                // newImg_.crossOrigin = "Anonymous";
                // newImg_.src = imgSrcURL;
                // newImg_.onload = () => {
                //   this.resizeCanvasRef
                //     .getContext("2d")
                //     .drawImage(newImg_, 0, 0, sanitizedWidth, sanitizedHeight);
                //   this.canvasRefImg.setAttribute(
                //     "src",
